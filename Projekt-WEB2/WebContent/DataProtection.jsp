...
<div id="footerSitesContainer">
	<div id="footerContent">
		...
		<p>Au&szlig;erdem haben Sie das Recht, unter bestimmten
		...
		<p>
			<strong>Wenn die Datenverarbeitung auf Grundlage von Art. 6
				Abs. 1 lit. e oder f DSGVO erfolgt, haben Sie jederzeit das Recht,
				...
				Rechtsanspr&uuml;chen (Widerspruch nach Art. 21 Abs. 1 DSGVO).</strong>
		</p>
		<p>
			<strong>Werden Ihre personenbezogenen Daten verarbeitet, um
				...
				Ihre personenbezogenen Daten anschlie&szlig;end nicht mehr zum
		...
		<p>Sie haben das Recht, die Einschr&auml;nkung der Verarbeitung
			...
			wenden. Das Recht auf Einschr&auml;nkung der Verarbeitung besteht in
		...
		<p>Die von Ihnen im Kontaktformular eingegebenen Daten verbleiben
			bei uns, bis Sie uns zur L&ouml;schung auffordern, Ihre Einwilligung
